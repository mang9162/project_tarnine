...
$_SESSION['PAGE'] = "../pages/seupsub_edit.php?act=view&id=".$doc_id;
...
if(isset($_GET['act'])){
    if($_GET['act'] == 'view' ){
        ...
        $disabled = '';
        $disSelect = '';
        $_SESSION['PAGE'] = "../pages/seupsub_edit.php?act=edit&id=".$doc_id;
    }
} else{
    $header = 'Edit';
    $disabled = '';
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="#"><span class="active">สืบทรัพย์</span></a></li>
    <li><a href="suepsub_list.php"><span class="active">สืบทรัพย์</span></a></li>
...
<div class="row">
        ...
        <button type="button" class="btn btn-app flat" onClick="goHref('../pages/seupsub_edit.php?act=edit&id=<?php echo $objResult['doc_id']?>')" title="edit">
        ...
        <?php } else {?>
        <button type="button" class="btn btn-app flat" onClick="goHref('../pages/seupsub_edit.php?act=view&id=<?php echo $objResult['doc_id']?>')" title="delete">
        ...
        <button type="button" class="btn btn-app flat"  onClick="goHref('seupsub_list.php')" title="discard">
