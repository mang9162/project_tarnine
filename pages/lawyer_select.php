...
if(!isset($_GET['view_list'])){
  ...
  $doc_id = "";
  $id = "";
  $_SESSION['PAGE'] = "../pages/lawyer_select.php?view_list=view_list";
}
$conDB = new db_conn();
	...
	while($objResult = mysqli_fetch_assoc($objQuery)) {
        ...
        ?>
            <tr>        
              ...
              <td style="padding:0px;"><a class="list" href="../services/lawyer_select.php?doc_id=<?php echo $doc_id; ?>&lawyer_id=<?php echo $objResult['lawyer_id']; ?>"><button type="button" class="btn btn-success btn-flat btn-block">เลือก</button></a></td>
              <td><?php echo $objResult['lawyer_name'] ?></td>
              <td align="center" style="font-size:16px;">
                <i class="fa fa-pencil text-yellow" onClick="goHref('../pages/lawyer_edit.php?lawyer_id=<?php echo $objResult['lawyer_id']; ?><?php echo $doc_id ?>')" title="edit"></i>
