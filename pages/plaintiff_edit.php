...
$strSQL = "SELECT * FROM `plaintiff` WHERE `plaintiff_id` = '$plaintiff_id'";
...
<div class="row">
        ...
        <button type="button" class="btn btn-app flat"  onClick="goHref('plaintiff_select.php<?php echo $doc_id ?>')" title="discard">
            ...
            <div class="box">
            	<div class="box-header with-border">
                  <h3 class="box-title">Plaintiff Info</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="plaintiff_name" name="plaintiff_name" class="form-control" placeholder="Name" value="<?php echo $objResult['plaintiff_name'];?>" maxlength="100" onChange="form_autosave('<?php echo $id;?>','<?php echo $table ?>','<?php echo $where_f ?>',this)" required />
                    </div> 
                    <div class="col-md-6">
                        <label>รหัสบัตรประชาชน <span class="text-red">*</span></label>
                        <input type="text" id="plaintiff_tex_no" name="plaintiff_tex_no" class="form-control" placeholder="0000000000000" value="<?php echo $objResult['plaintiff_tex_no'];?>" maxlength="20" onChange="form_autosave('<?php echo $id;?>','<?php echo $table ?>','<?php echo $where_f ?>',this)" />
                    </div> 
                    <div class="col-md-6">
            ...
            <div class="box">
            	<div class="box-header with-border">
                  <h3 class="box-title">Plaintiff Current Info</h3>
                  <div class="box-tools pull-right">
                     <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                  </div>
                </div>
            ...
            <div class="box">
            	<div class="box-header with-border">
                  <h3 class="box-title">Plaintiff Work Info</h3>
                  <div class="box-tools pull-right">
                     <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                  </div>
                </div>
